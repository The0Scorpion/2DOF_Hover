...
PRODUCT_NAME              = TwoDOF
MAKEFILE                  = TwoDOF.mk
MATLAB_ROOT               = F:/00_Programs/MATLAB/R2023b
MATLAB_BIN                = F:/00_Programs/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = F:/College/Semester_10/GP2/2DOF/2DOF_Hover/Model/2DOF_SL
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/user/DOCUME~1/MATLAB/R2023b/ARDUIN~1/ESP32W~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TwoDOF.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=3 -DMW_PRESCALAR=64 -DMW_TIMERCOUNT=64286 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=3 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL1_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL2_=SERIAL_8N1 -D_RTT_TX_PIN_SERIAL0_=1 -D_RTT_RX_PIN_SERIAL0_=3 -D_RTT_TX_PIN_SERIAL1_=33 -D_RTT_RX_PIN_SERIAL1_=32 -D_RTT_TX_PIN_SERIAL2_=17 -D_RTT_RX_PIN_SERIAL2_=16 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=TwoDOF -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.S.o : $(START_DIR)/TwoDOF_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/TwoDOF_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
IMU_Michael.o : $(START_DIR)/SourceFiles/EncoderIMU/IMU_Michael.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
ert_main.o : $(START_DIR)/TwoDOF_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


TwoDOF.o : $(START_DIR)/TwoDOF_ert_rtw/TwoDOF.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


TwoDOF_data.o : $(START_DIR)/TwoDOF_ert_rtw/TwoDOF_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
